...
class AppColors {
  ...
  static final Color darkerGreen = Color(0xFF065C1F);
  ...
  static final Color levelButtonHero = lightRed;
  ...
  static final Color levelButtonBorderHero = red;
  ...
  static final Color levelButtonTextHero = darkRed;
}
